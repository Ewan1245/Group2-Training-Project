    ...
    <Router>
      ...
      <div className="container mt-5">
        ...
        <Switch>
          ...
          {ingredients.length==0 && <Route path="/" element={<FeaturedRecipes setError={setError} />} />}
          ...
          {ingredients.length>0 && <Route path="/" element={<Recipes ingredients={ingredients} setError={setError} />} />}
